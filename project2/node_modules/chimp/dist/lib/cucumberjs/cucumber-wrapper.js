...
function createIpcFormatter() {
  ...
  var finish = ipcFormatter.finish;
  ipcFormatter.finish = function sendResultToChimp(callback) {
    var _this = this;

    finish.call(this, function (error, result) {
      var results = _this.getLogs();
      process.send(results, function () {
